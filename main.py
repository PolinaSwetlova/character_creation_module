...
def attack(char_name: str, char_class: str) -> str:
    """Нападение: нанесение урона, в зависимости от выбранного персонажа."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс противнику урон, равный '
                f'{5 + randint(-3, -1)}')
    return (f'{char_name} не нанёс урон ни одному противнику')


def defence(char_name: str, char_class: str) -> str:
    """Защита: блокировка урона, в зависимости от персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применение специального навыка, в зависимости от персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Начало тренировки: 1-Обозначение персонажа. 2-Применение навыков."""
    if char_class == 'warrior':
